...
//
//     final allproductsResModel = allproductsResModelFromJson(jsonString);

import 'dart:convert';

AllproductsResModel allproductsResModelFromJson(String str) => AllproductsResModel.fromJson(json.decode(str));
...
class AllproductsResModel {
    ...
    factory AllproductsResModel.fromJson(Map<String, dynamic> json) => AllproductsResModel(
