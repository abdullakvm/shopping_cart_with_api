    ...
    WidgetsBinding.instance.addPostFrameCallback(
      (timeStamp) {
        context
            ...
            .fetchproductdetails(proid: widget.productid);
      },
    );
  }
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          productDetailsScreenController.response?.title ?? "",
                          style: TextStyle(
                              color: Colors.black,
                        ...
                        SizedBox(height: 20),
                        Text(
                          "⭐ ${productDetailsScreenController.response?.rating.toString() ?? ""}",
                          style: TextStyle(
                              color: Colors.black,
                              fontWeight: FontWeight.bold,
                              fontSize: 16),
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                            "RS ${productDetailsScreenController.response?.price ?? ""}",
                            style: TextStyle(
                                color: Colors.black,
                                fontWeight: FontWeight.bold,
                                fontSize: 20),
